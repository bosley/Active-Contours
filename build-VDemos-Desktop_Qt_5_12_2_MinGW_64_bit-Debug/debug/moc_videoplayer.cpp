...
#include "../../src/MediaManager/videoplayer.h"
...
QT_MOC_LITERAL(1, 12, 14), // "processedImage"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5), // "image"
QT_MOC_LITERAL(4, 34, 10) // "endOfInput"

    },
    "VideoPlayer\0processedImage\0\0image\0"
    "endOfInput"
};
...
void VideoPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoPlayer::processedImage)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoPlayer::endOfInput)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void VideoPlayer::processedImage(const QImage & _t1)
{
